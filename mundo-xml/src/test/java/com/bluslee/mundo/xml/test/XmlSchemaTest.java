...
public class XmlSchemaTest {
    ...
    public void bean2XmlTest(){
        ...
        XmlSchema.ProcessNodeSchema end = new XmlSchema.ProcessNodeSchema("end", "审批结束");
        processSchema.setProcessNodeList(Arrays.asList(supCreate, supSubmit, buyerApprove, supUpdate, end));
        ...
        processSchema.setProcessExclusiveGatewayList(Collections.singletonList(processExclusiveGatewaySchema));
        ...
        processSchema.setProcessLinkSchemaList(Arrays.asList(supCreate2submit, supSubmit2buyerApprove, buyerApprove2Gateway, gateway2supUpdate, gateway2end));
